...
**Docker Image:** İçerisinde uygulamaları barındıran konteyner oluşturmak için kullanılan önceden hazırlanmış sistem imajlarıdır.

**Dockerfile:** Docker imajları bazı durumlarda önceden belirlenmiş kurallar ve komutlar ile Dockerfile adı verilen özel formattaki dosyalar baz alınarak oluşturulabilir.
